...
function StratBook() {
    ...
    // --------------------------
    // ✅ FIX: safer icon shape renderer (prevents nested ternary paste bugs)
    // --------------------------
