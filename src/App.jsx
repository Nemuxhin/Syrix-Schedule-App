/*
Syrix Team Availability - v12.0 (VALOPLANT ENGINE COMPLETE)
- FEATURE: Select specific Agent Utilities (Sage Wall, Cypher Trip, etc).
- FEATURE: Click icons on map to ROTATE and RESIZE them.
- FEATURE: Added Map Markers (A, B, C, Spawn).
- CORE: Includes all Dashboard, Roster, and Admin features in one file.
*/
