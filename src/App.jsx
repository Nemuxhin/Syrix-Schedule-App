/*
Syrix Team Availability - v12.4 (COMPS RESTORED)
- FIX: Restored the missing Team Comps tab logic.
- CORE: Full ValoPlant StratBook + Playbook + Dashboard.
- UI: Centered Login, 16:9 StratBook, 60FPS Animations.
*/
